...
DeskEye is an open-source system that allows you to reuse your Android smartphone's camera as a high-quality virtual webcam on your computer.
...
1. **On your phone**: Install `DeskEye.apk`, open it, grant camera permissions, and click **Start server**.
...
4. **Use**: Open The app which you want to use the webcam and select **"DeskEye"** or **"Unity Video Capture"** as your webcam

---

## Architecture and Operation

* **Mobile**: Kotlin, Jetpack Compose, CameraX, NanoHTTPD.
* **PC**: Python 3, PyQt6, OpenCV, PyVirtualCam.
